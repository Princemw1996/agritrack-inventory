async function renderMinSend() {
    ...
    container.innerHTML = `
        ...
        <div style="overflow-x:auto;"><table style="width:100%; border-collapse:collapse;"><thead><tr><th>Product (only in stock)</th><th>Shop</th><th>Quantity</th><th></th></td></thead><tbody id="sendTableBody"></tbody></table></div>
